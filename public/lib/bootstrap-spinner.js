...
+(function ($) {
  ...
  var Spinner = function (element, options) {
    ...
    const value = new Number(this.$element.val());
  ...
  Spinner.prototype.step = function (value) {
    ...
    let current = new Number(this.$element.val());
  ...
  Spinner.prototype.change = function (value) {
    ...
    let e = $.Event('change.bs.spinner', { value });
  ...
  const old = $.fn.spinner;

  $.fn.spinner = function (option, arg) {
    return this.each(function () {
      const $this = $(this);
      let data = $this.data('bs.spinner');
      const isNew = (typeof data === 'object');
